...
export default function ListDetailScreen() {
  ...
  useFocusEffect(
    useCallback(() => {
      getLists().then((all) => {
        setList(all.find((l) => l.id === listId) ?? null);
      });
    }, [listId])
  );

  const handleRemove = (book: SavedBook) => {
    Alert.alert('Retirer', `Retirer "${book.title}" de cette liste ?`, [
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.empty}>
            ...
            <Text style={styles.emptyTitle}>Aucun livre ici</Text>
            <Text style={styles.emptySubtitle}>
              Ouvre un livre et appuie sur "Add to library" pour l'ajouter ici.
            </Text>
          </View>
        }
        ListFooterComponent={
